...
Defines the Docusaurus-based documentation hub platform that hosts GuateGeeks educational programs: the site scaffold itself, program-namespaced routing so multiple programs can coexist, bilingual (es/en) internationalization, static asset hosting for downloadable and media files, and the hub's branding and landing page.
