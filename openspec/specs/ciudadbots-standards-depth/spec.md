...
Defines the per-module "CNB y estándares" tab content: grade-depth reading guidance, grade-specific achievement indicators, ISTE/CSTA/NGSS progression content, official CNB source links, and the requirement that shared standards content be defined once and reused across all modules and the overview page.
