...
Defines the GuateGeeks hub's brand image assets — favicon and Open Graph social card — derived from the hub logo, and ensures they resolve correctly under the site's deployment `baseUrl`.
